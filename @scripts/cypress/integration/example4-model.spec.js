"use strict";
describe('Example 4 - Model', function () {
    ...
    it('should display the text "Showing all 50000 rows" without Pagination', function () {
        var expectedRows = ['Task 0', 'Task 1', 'Task 2', 'Task 3', 'Task 4'];
    ...
    it('Should display "Showing page 1 of 1000" text after changing Pagination to 50 items per page', function () {
    ...
    it('Should display "Showing page 2 of 1000" text after clicking on next page', function () {
        var expectedRows = ['Task 50', 'Task 51', 'Task 52', 'Task 53', 'Task 54'];
    ...
    it('Should display "Showing page 1000 of 1000" text after clicking on last page', function () {
        var expectedRows = ['Task 49950', 'Task 49951', 'Task 49952', 'Task 49953', 'Task 49954'];
