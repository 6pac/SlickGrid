"use strict";
describe('Example - Row Detail/Row Move/Checkbox Selector Plugins', function () {
    ...
    it('should display Example Row Detail/Row Move/Checkbox Selector Plugins', function () {
    ...
    it('should open the Row Detail of the 2nd row and expect to find some details', function () {
    ...
    it('should drag opened Row Detail to another valid position in the grid', function () {
    ...
    it('should expect row to be moved to another row index', function () {
    ...
    it('should try moving a row to an invalid target and expect nothing moved (same rows as prior test)', function () {
        cy.get('[style="top:25px"] > .slick-cell.cell-reorder').as('moveIconTask1');
        cy.get('[style="top:100px"]').as('expandIconTask4');
    ...
    it('should select 2 rows (Task 1,3), then move row and expect the 2 rows to still be selected without any other rows', function () {
    ...
    it('should click on "Single Row Move OFF", then drag a row and expect both selected rows to be moved together', function () {
    ...
    it('should open the Task 3 Row Detail and still expect same detail', function () {
        cy.get('[style="top:175px"] > .slick-cell:nth(4)').should('contain', 'Task 3');
