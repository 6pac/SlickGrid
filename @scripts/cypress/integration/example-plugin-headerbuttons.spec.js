"use strict";
describe('Example - Header Button', function () {
    var titles = ['Resize me!', 'Hover me!', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'];
    beforeEach(function () {
    ...
    it('should go over the 3rd column "C" and expect to see negative number in red after clicking on the blue header button', function () {
        ...
        cy.get('#myGrid')
            ...
            cy.wrap($row).children('.slick-cell:nth(2)')
                .each(function ($cell) {
                var numberValue = $cell.text();
                var htmlValue = $cell.html();
                if (+numberValue < 0) {
    ...
    it('should go over the 5th column "E" and not find the blue header button', function () {
        cy.get('.slick-header-columns')
    ...
    it('should go over the last column "J" and expect to find the blue header button, however it should be usable and number should not display as red', function () {
        ...
        cy.get('#myGrid')
            ...
            cy.wrap($row).children('.slick-cell:nth(9)')
                .each(function ($cell) { return expect($cell.html()).to.eq($cell.text()); });
        });
    });
    it('should resize 1st column and make it wider', function () {
        cy.get('.slick-viewport-top.slick-viewport-left')
            .scrollTo('left')
            .wait(50);
        var stub = cy.stub();
        ...
        cy.get('.slick-header-column:nth(0)')
            ...
            .each(function ($elm) { return $elm.width(140); })
    ...
    it('should go on the 2nd column "Hover me!" and expect the header button to appear only when doing hover over it', function () {
        cy.get('.slick-header-columns')
